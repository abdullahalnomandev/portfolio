...
const ContactPage = () => {
  ...
  return (
    <>
      <section className='min-h-screen pb-8  bg-[#f0f5ff] flex flex-col md:flex-row gap-12 sm:p-8 md:p-16 font-sans text-gray-900'>
        {/* Left Form Section */}
        <div
          className='flex-1 bg-[#e8efff] rounded-xl p-10 max-w-lg'
          data-aos='fade-right'>
